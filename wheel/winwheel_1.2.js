...
prizes[0] = {"name" : "Sac de Shopping Ooredoo", "startAngle" : 0,   "endAngle" : 44};  // Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "Porte portable Ooredoo", "startAngle" : 45,  "endAngle" : 89};
prizes[2] = {"name" : "Cl\351 USB Ooredoo", "startAngle" : 90,  "endAngle" : 134};
prizes[3] = {"name" : "Recharge 10DT Ooredoo", "startAngle" : 135, "endAngle" : 179};
prizes[4] = {"name" : "Sac de Shopping Ooredoo", "startAngle" : 180, "endAngle" : 224};
prizes[5] = {"name" : "Porte portable Ooredoo", "startAngle" : 225, "endAngle" : 269};
prizes[6] = {"name" : "Cl\351 USB Ooredoo", "startAngle" : 270, "endAngle" : 314};
prizes[7] = {"name" : "Recharge 5DT Ooredoo", "startAngle" : 315, "endAngle" : 360};
		...
		if ((doPrizeDetection) && (prizes))
		{
			...
			for (x = 0; x < (prizes.length); x ++)
			{
				if ((relativeAngle >= prizes[x]['startAngle']) && (relativeAngle <= prizes[x]['endAngle']))
				{
					...
					alert("Vous avez gagn\351 " + prizes[x]['name'] + "!");
					break;
				}
			}
		}
